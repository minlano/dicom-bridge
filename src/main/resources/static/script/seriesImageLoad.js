...
const icChildren = imageContainer.childNodes;
const icChildrenArray = Array.from(icChildren);
var imageContainer2 = document.getElementById('image-container2');
const ic2Children = imageContainer2.childNodes;
const ic2ChildrenArray = Array.from(ic2Children);
