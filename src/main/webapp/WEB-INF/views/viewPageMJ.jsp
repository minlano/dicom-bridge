...
<div class="container">
    ...
    <div class="page-header">
        <h1>DICOM Summary</h1>
        <p class="lead">
            Drag and drop a DICOM Part 10 file into the region below for a summary of the key elements.
        </p>
        <p>
            This example illustrates how to extract known elements from the data set for display in a web page.
...
<script>window.dicomParser || document.write('<script src="/script/dicomParser.js">\x3C/script>')</script>
